#!/usr/bin/env python
# shephrds_all_list_combinations_thru_find_overlap_in_lists_and_sys_name_to_std.py by Wayne Decatur
# ver 0.1
#
#*******************************************************************************
...
# redirect like so
# `shephrds_all_list_combinations_thru_find_overlap_in_lists_and_sys_name_to_std.py list1.txt list2.txt list3.txt > commands.txt`.
...
#
#
# related script is: `shephrds_all_list_combinations_thru_find_overlap_in_lists.py`
#
#
#
#
...
#-----------------------------------
# python shephrds_all_list_combinations_thru_find_overlap_in_lists_and_sys_name_to_std.py list1.txt list2.txt list3.txt list4.txt list5.txt
#-----------------------------------
#
#
#*******************************************************************************
...
parser = argparse.ArgumentParser(prog='shephrds_all_list_combinations_thru_find_overlap_in_lists_and_sys_name_to_std.py',description="shephrds_all_list_combinations_thru_find_overlap_in_lists_and_sys_name_to_std.py \
