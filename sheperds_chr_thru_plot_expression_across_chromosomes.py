#!/usr/bin/env python
# sheperds_chr_thru_plot_expression_across_chromosomes.py by Wayne Decatur
# ver 0.1
#
#*******************************************************************************
...
#-----------------------------------
# python sheperds_chr_thru_plot_expression_across_chromosomes.py
#-----------------------------------
#
#
#*******************************************************************************
...
parser = argparse.ArgumentParser(prog='sheperds_chr_thru_plot_expression_across_chromosomes.py',description="sheperds_chr_thru_plot_expression_across_chromosomes.py \
    blah blah blah \
