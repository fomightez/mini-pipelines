#!/usr/bin/env python
# sheperds_all_list_combinations_thru_find_overlap_in_lists_and_sys_name_to_std.py by Wayne Decatur
# ver 0.1
#
#*******************************************************************************
...
# `find_overlap_in_lists.py` and a special version of
...
# `find_overlap_in_lists.py` and the special version of
...
# redirect like so
# `sheperds_all_list_combinations_thru_find_overlap_in_lists_and_sys_name_to_std.py list1.txt list2.txt list3.txt > commands.txt`.
...
#
#
# related script is: `sheperds_all_list_combinations_thru_find_overlap_in_lists.py`
#
#
#
#
...
#-----------------------------------
# python sheperds_all_list_combinations_thru_find_overlap_in_lists_and_sys_name_to_std.py list1.txt list2.txt list3.txt list4.txt list5.txt
#-----------------------------------
#
#
#*******************************************************************************
...
parser = argparse.ArgumentParser(prog='sheperds_all_list_combinations_thru_find_overlap_in_lists_and_sys_name_to_std.py',description="sheperds_all_list_combinations_thru_find_overlap_in_lists_and_sys_name_to_std.py \
